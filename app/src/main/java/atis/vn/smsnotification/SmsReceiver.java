...
public class SmsReceiver extends BroadcastReceiver {
    ...
    private static final String TAG = "carpla-thangnm-dev";
    ...
    public void onReceive(Context context, Intent intent) {
        Log.d("message_from", "tin nhan  den"+ intent.getAction());
...
//            }
            ...
            Log.e(TAG, "result_add_db: " + addResult);
            if (addResult) {
...
//                        }
    ...
    private String checkMatchBankSMS(String content) {
        Pattern pattern = Pattern.compile(MATCH_TRANS_CODE_REGEX);
